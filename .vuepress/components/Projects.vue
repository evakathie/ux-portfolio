<template>
  <div class="projects">
      <div class="wrapper">
          ...
          <router-link to="/pages/planeatary.html">
            <div class="project first">
                    <img :src="'/images/planeatary/planeatary.png'">
                    <div class="text">
          ...
          <router-link to="/pages/cookie-notices.html">
            <div class="project">
                    <img :src="'/images/cookie-notices/cookie-notices.png'">
                    <div class="text">
            ...
            <router-link to="/pages/spotify-audiobooks.html">
              <div class="project last">
                      <img :src="'/images/spotify-audiobooks/audiobooks.png'">
                      <div class="text">
...
.projects {
    ...
    .project {
        ...
        &:hover {
            ...
            h3, p {
                text-decoration: underline solid color(color_hover);
            }
        }
